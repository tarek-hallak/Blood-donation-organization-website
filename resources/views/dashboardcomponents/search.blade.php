<!--begin::Search-->
<div class="flex" style="padding-left: 620px">
    ...
    <form data-kt-search-element="form" class="w-100 position-relative" autocomplete="off">
        ...
        <!--end::Icon-->
        <!--begin::Input-->
        <input type="text" class="form-control ps-13 fs-7 h-40px" name="search" value="{{request('search')}}"
               placeholder="Search for blood type" data-kt-search-element="input" />
        <!--end::Input-->
        <!--begin::Spinner-->
